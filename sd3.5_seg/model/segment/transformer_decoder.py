...
class seg_decorder(nn.Module):
    ...
    def forward(self,diffusion_features):
        ...
        pos = None##self.pe_layer(x, None).flatten(2)
        src = self.input_proj[0](x).flatten(2) + self.level_embed.weight[0][None, :, None]
        #print('src',src.shape) 
        ...
        for i in range(self.num_layers):
            ...
            #print(' src[level_index]', src.shape)
